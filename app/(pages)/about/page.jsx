...
<section className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
  ...
  <div className="relative">
    ...
    <div className="absolute left-1/2 h-full w-0.5 bg-gradient-to-b from-purple-500 to-blue-500 transform -translate-x-1/2" />
    ...
    {[
      ...
      {
        year: "Jan, 2025",
        event: "First Brainstorm",
        description: "Built a prototype in figma in my dorm room",
      ...
      {
        year: "Apr, 2025",
        event: "Version 1.0 launched",
        description: "1Deployed first prototype, got many users in 1 week",
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className={`mb-8 flex ${item.side === 'left' ? 'justify-start mr-auto pr-8' : 'justify-end ml-auto pl-8'} relative`}
        style={{ maxWidth: 'calc(50% - 16px)' }}
      >
        {/* Timeline dot */}
        <div className={`absolute top-0 ${item.side === 'left' ? 'right-0' : 'left-0'} w-4 h-4 rounded-full bg-gradient-to-br from-purple-600 to-blue-600 transform translate-x-1/2`} />
        
        <div className={`bg-gray-800/50 p-6 rounded-xl border border-gray-700 backdrop-blur-sm ${item.side === 'left' ? 'text-right' : 'text-left'}`}>
          <div className={`flex ${item.side === 'left' ? 'justify-end' : 'justify-start'} mb-2`}>
            <div className={`bg-gradient-to-br from-purple-600/20 to-blue-600/20 w-10 h-10 rounded-full flex items-center justify-center ${item.side === 'left' ? 'ml-2' : 'mr-2'}`}>
              {item.icon}
            </div>
          </div>
